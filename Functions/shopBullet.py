...
bulletNumberUp = pygame.image.load("img/UI/canons.png")
...
bulletFirerateUp = pygame.image.load("img/UI/fireRate.png")
bulletFirerateUp = pygame.transform.scale(bulletFirerateUp, (200, 75))
bulletDamage = pygame.image.load("img/UI/damage.png")
