...
from Functions.enemiesPattern import miniBossPatern
import pygame, math
...
class miniBoss():
    ...
    def takeDmg(self, dmg, enemyList):
        ...
        if(self.health <= 0):
            ...
            if self.patternNum != 3:
                self.patternNum = 3
                self.changePattern()
        elif self.health <= 500 and self.health > 300:
    ...
    def changePattern(self):
        ...
        if self.patternNum == 1:
            ...
            BH3 = [1, 3, 5, 15, missileRed, True, 0]
            self.BHdata.append(BH1)
            self.BHdata.append(BH2)
            ...
            BH2 = [1.5, 8, 3, 10, bigBallRed, True, 0]
            BH3 = [0.5, 2, 8, 45, bulletBlue, False, 3]
            BH4 = [1, 3, 1, 0, missileRed, True, 0]
            self.BHdata.append(BH1)
            self.BHdata.append(BH2)
            self.BHdata.append(BH3)
